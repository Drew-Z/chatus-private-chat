...
assert(reactWorkspaceHeader.includes("route.model") && reactWorkspaceHeader.includes("<ModelAvailabilityBadge") && reactWorkspaceHeader.includes("connectionState"), "React workspace header: logical model, passive availability, and connection state are missing");
...
assert(!reactOperationsAdmin.includes("style={{"), "React admin: operations visualization must use stylesheet classes instead of inline styles");
