...
- Keep the Cloudflare Vitest test timeout at 10 seconds. Large cross-Durable-Object integration cases exceed the framework's 5-second default on Windows even when their assertions complete; do not work around this by starting multiple Vitest processes or skipping those cases.
