...
assert(reactClient.includes('body: () => ({ routeId, skillMode, skillIds, chatId: conversation.id })'), "React client: Agent turns must include route, Skill mode, Skill selection, and conversation state");
